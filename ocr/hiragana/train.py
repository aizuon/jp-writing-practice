...
train_images = np.load("./data/hiragana_train_images.npz")["arr_0"]
train_labels = np.load("./data/hiragana_train_labels.npz")["arr_0"]
test_images = np.load("./data/hiragana_test_images.npz")["arr_0"]
test_labels = np.load("./data/hiragana_test_labels.npz")["arr_0"]
